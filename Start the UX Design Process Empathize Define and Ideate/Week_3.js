...
/*
    Problem statement
        ...
        - Human-centered
        - Broad enought for creative freedom
        - Narrow enough to be solved by a design

    *username* is a *user characteristics*
    who needs *user need*
    because *insight*.
...
/*
    ...
    After you define the user’s pain points, you can answer who, what, when, where, why, and 
...
//Activity Exemplar: Builad a problem statement and hypothesis statement for the CoffeeHouse project
